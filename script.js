...
const layerList = [
  { ...baseConfig, src: "./assets/background.png", zIndex: -3.5 },

  { ...baseConfig, src: "./assets/backgroundShape.png", zIndex: 2 },
  { ...baseConfig, src: "./assets/visitorsBack.png", zIndex: -2 },

  { ...baseConfig, src: "./assets/mask.png", zIndex: 0 },
  {
    ...baseConfig,
    src: "./assets/fingerBack.png",
    mode: "isMoving",
    zIndex: 2.9,
  },
  { ...baseConfig, src: "./assets/fingerPro.png", zIndex: 3 },
  { ...baseConfig, src: "./assets/visitors.png", zIndex: 3.5 },
  { ...baseConfig, src: "./assets/visitorsId.png", zIndex: 4 },
];
